...
async def _phase_one(A, b, x0, callback, postsolve_args, maxiter, tol, disp,
...
async def _phase_two(c, A, x, b, callback, postsolve_args, maxiter, tol, disp,
...
async def _linprog_rs(c, c0, A, b, x0, callback, postsolve_args,
