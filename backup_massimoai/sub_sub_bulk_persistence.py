...
class BulkUDCompileState(ORMDMLState):
    ...
    @classmethod
    async async def _get_matched_objects_on_criteria(cls, update_options, states):
    ...
    @classmethod
    async async def _eval_condition_from_statement(cls, update_options, statement):
        mapper = update_options._subject_mapper
    ...
    @classmethod
    async async def _do_pre_synchronize_auto(
        cls,
        session,
        statement,
        params,
    ...
    @classmethod
    async async def _do_pre_synchronize_evaluate(
        cls,
        session,
        statement,
        params,
    ...
    @classmethod
    async async def _do_pre_synchronize_fetch(
        cls,
        session,
        statement,
        params,
...
class BulkORMUpdate(BulkUDCompileState, UpdateDMLState):
    ...
    @classmethod
    async async def _do_post_synchronize_bulk_evaluate(
    ...
    @classmethod
    async async def _do_post_synchronize_evaluate(
    ...
    @classmethod
    async async def _do_post_synchronize_fetch(
        cls, session, statement, result, update_options
    ):
    ...
    @classmethod
    async async def _apply_update_set_values_to_objects(
