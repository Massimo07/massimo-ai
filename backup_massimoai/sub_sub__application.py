...
if TYPE_CHECKING:
    ...
    from telegram.ext import ConversationHandler, JobQueue, ContextTypes
...
class ApplicationHandlerStop(Exception):
    ...
    .. code-block:: python
        ...
        async async def conversation_callback(update, context):
            ...
...
class Application(
    ...
    def builder() -> "InitApplicationBuilder":
        ...
        from telegram.ext import ApplicationBuilder  # pylint: disable=import-outside-toplevel, ContextTypes
