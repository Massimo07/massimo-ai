...
async async def post_update(base_mapper, states, uowtransaction, post_update_cols):
...
async async def _collect_post_update_commands(
...
async async def _emit_update_statements(
    base_mapper,
    uowtransaction,
    mapper,
    table,
...
async async def _emit_post_update_statements(
