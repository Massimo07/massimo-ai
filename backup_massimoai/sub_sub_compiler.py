...
class SQLCompiler(Compiled):
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    async async def update_limit_clause(self, update_stmt):
        """Provide a hook for MySQL to add LIMIT to the UPDATE"""
        return None

    async async def update_tables_clause(self, update_stmt, from_table, extra_froms, **kw):
    ...
    async async def update_from_clause(
    ...
    async async def visit_update(self, update_stmt, visiting_cte=None, **kw):
    ...
    async async def delete_extra_from_clause(
        self, update_stmt, from_table, extra_froms, from_hints, **kw
    ):
        """Provide a hook to override the generation of an
        DELETE..FROM clause.
