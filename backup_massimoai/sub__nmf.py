...
async def _fit_coordinate_descent(
    X,
    W,
    H,
    tol=1e-4,
...
async def _multiplicative_update_w(
    X,
    W,
    H,
    beta_loss,
...
async def _fit_multiplicative_update(
    X,
    W,
    H,
    beta_loss="frobenius",
...
async def non_negative_factorization(
    X,
    W=None,
    H=None,
    n_components="warn",
...
class _BaseNMF(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator, ABC):
    ...
    async def _check_w_h(self, X, W, H, update_H):
...
class NMF(_BaseNMF):
    ...
    async def _fit_transform(self, X, y=None, W=None, H=None, update_H=True):
        """Learn a NMF model for the data X and returns the transformed data.
...
class MiniBatchNMF(_BaseNMF):
    ...
    async def _minibatch_step(self, X, W, H, update_H):
    ...
    async def _fit_transform(self, X, W=None, H=None, update_H=True):
        """Learn a NMF model for the data X and returns the transformed data.
